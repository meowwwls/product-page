...
const EmptyCart = props => (
  <div id="cart-header" className="empty-cart container">
    <p>Your cart is currently empty.</p>
    <svg id="icon-shopping-bag" viewBox="0 0 24 24" width="200" height="200">
      ...
      <path d="M16 9c-0.6 0-1 0.4-1 1 0 1.7-1.3 3-3 3s-3-1.3-3-3c0-0.6-0.4-1-1-1s-1 0.4-1 1c0 2.8 2.2 5 5 5s5-2.2 5-5c0-0.6-0.4-1-1-1z" />
    </svg>
  </div>
);
