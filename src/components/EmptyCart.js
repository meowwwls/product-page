...
const EmptyCart = props => (
  <div id="cart-header">
    ...
    <svg id="icon-crying" viewBox="0 0 32 32" width="100" height="100">
      ...
      <path className="tear--right" d="M23 18c-0.552 0-1-0.448-1-1v-2c0-0.552 0.448-1 1-1s1 0.448 1 1v2c0 0.552-0.448 1-1 1z" />
      <path className="tear--right" d="M23 24c-0.552 0-1-0.448-1-1v-2c0-0.552 0.448-1 1-1s1 0.448 1 1v2c0 0.552-0.448 1-1 1z" />
      <path className="tear--left" d="M9 18c-0.552 0-1-0.448-1-1v-2c0-0.552 0.448-1 1-1s1 0.448 1 1v2c0 0.552-0.448 1-1 1z" />
      <path className="tear--left" d="M9 24c-0.552 0-1-0.448-1-1v-2c0-0.552 0.448-1 1-1s1 0.448 1 1v2c0 0.552-0.448 1-1 1z" />
    </svg>
  </div>
);
